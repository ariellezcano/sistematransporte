...
@Component({
  selector: 'app-cajachica',
  templateUrl: './cajachica.component.html',
  styleUrls: ['./cajachica.component.scss']
})
export class CajachicaComponent implements OnInit {

  @ViewChild("close", { static: false }) close: ElementRef;
  public items: CajaChica[]
  public item: CajaChica;


  constructor(private wsdl: CajaChicaService) {

    this.item = new CajaChica();
    this.items = []
  }
  ...
  preEliminar(item: CajaChica) {
    this.item = item;
    Swal.fire({
      title: 'Usted está seguro de eliminar?',
      text: 'Desea eliminar el archivo!' + item.monto,
      icon: 'warning',
  ...
  */
  seleccionado(CajaChica: CajaChica) {
    this.item = CajaChica;
